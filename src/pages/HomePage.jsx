...
import {
  ...
  servicesCover, productions, moto, bggradiant, TheDancerEYNK
} from '../utils/config';
        ...
        <div ref={latestNewsRef} className="p-10 w-full bg-white flex flex-col items-center">
          <div className="max-w-6xl w-full flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2 flex flex-col justify-center">
              ...
              <h3 className="text-xl md:text-2xl font-semibold mb-2">THE DANCER | Everything you need to know</h3>
              ...
              <a href="https://youtu.be/NgEuDuK1wYU" target="_blank" className="mt-4 text-blue-600 font-semibold hover:underline">Watch now →</a>
            </div>
            {/* Image Section */}
